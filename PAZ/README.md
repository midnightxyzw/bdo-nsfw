...
(Note: this file is written in Markdown syntax. Read it using Markdown viewer, like https://markdownlivepreview.com/)
...
This is nude model and skin for all female classes (except Shai), up to Scholar, originally created by fantastic [Suzu](https://www.undertow.club/downloads/authors/suzu-%E9%88%B4.26775/). This is the fixed/improved version from Discord user [TheGreateSage](https://discord.com/channels/524568440254627850/1170031675409957045)
...
This mod hides all armors for all classes (except Shai), up to Scholar. It has 2 options to allow you to customize which subset of outfits/armors to remove/hide from the game:
  ...
  - option 2: Free items only/Pearl items only/Everything.

So total 9 combinations for you to choose from. The Free VS. Pearl item separation is not perfect but should work in majority of cases
